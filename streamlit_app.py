...
#The following involves lots of questions about TUM.ai (~3150 tokens), we should definitely check the content of this text
#
# Q: What is amazing about TUM.ai?
# A: A great diverse Community of inspiring people. You can learn from each other. You can drive and develop the AI ecosystem. Network with Members, Partners, Alumni, industry leaders and other initiatives. Get out as much as you give into it.
#
# Q: What we expect from you as a TUM.ai Member?
# A: Passion for AI. Motivation to push our initiative forward. To be available and react on topics within a short timeframe. To invest a time of at least 6h per week for the initiative and its projects. To be committed. You should be Munich-based to attend in-person meetings and events.
#
# Q: What should I know about TUM.ai?
# A: We are not an educational program. That means you are not only joining to learn, but also to contribute to the development of the organization. We don’t give in-depth lectures or crash courses in AI and coding yet - to learn things you need to interact with other members. Help is always given to those who ask. We do a lot of organizational work - the AI ecosystem is not ready and you will be part of building it up. We expect you to work min. 6h per week for the initiative and its projects, for your personal involvement and learning you need to spend time on top.
#
# Q: How much does it cost to be a member of TUM.ai?
# A: We have a membership fee of €2/month (24€ per year) for everyone.
#
# Q: Why should I join TUM.ai?
# A: You should join TUM.ai if you are passionate about AI and want to contribute to the development of the organization. You should also join TUM.ai when you want to learn from other members and be a part of a great diverse community.
#
# Q: Which departments do you have?
# A: TUM.ai is student initiative in form of a non-profit organization with AI focus. We are structured into departments. We have 2 kinds of departments, the mission-based and the functional departments. The mission-based departments focus their work on realizing out mission. The functional departments provide resources for them. Check out the details about each department! Our departments are Software development, Marketing, Finance & Legal, Community, Partners & Sponsors, Makeathon, Venture, Industry, Education.
#
...
# A: We expect you to work min. 6h per week for the initiative and its projects.
#
...
#
# Q: Who is the president of TUM.ai?
# A: TUM.ai is currently lead by 3 co-presidents: Luca, Leonie,  Toaha.
#
...
#
# Q: What is the mission of TUM.ai?
# A: TUM.ai connects students and all relevant stakeholders to facilitate the application of AI across domains to drive positive societal impact through interdisciplinary projects.Bring together companies and students through projects
...
# A: Slack, Instagram (tum.ai_official), and Linkedin.
#
# Q: How many members does TUM.ai have?
# A: TUM.ai currently has about more than 100 members.
#
...
#
# Q: How can I participate in Makeathon?
# A: TUM.ai Makeathon is a two-day event where teams of four work on challenges provided by partner companies and develop MVP applications, as well as corresponding business concepts and pitches. If you want to participate, you can apply here: https://join-us.tum-ai.com/makeathon/
#
...
#
# Q: How can I get more information about a department?
# A: You can visit our website (https://join-us.tum-ai.com/) to find more information about the departments.
#
